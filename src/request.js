const API_KEY = "9beec7bb44645198956ef5b0390b36d8";
...
const requests = {
  ...
  fetchCommdyMovies: `discover/movie?api_key=${API_KEY}&with&genres=35`,
  ...
  fetchDocumnetaries: `discover/movie?api_key=${API_KEY}&with&genres=99`,
};
